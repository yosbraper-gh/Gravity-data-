# -*- coding: utf-8 -*-
"""
Created on Tue Apr 21 15:06:02 2026
...
gdf_lineas = gpd.read_file('datos_lineas_final_reunion_4.gpkg')
...
df_final = gdf_puntos[['longitude', 'latitude', 'AB (mGal)']]

# 2. Exportamos la tabla a un archivo CSV
df_final.to_csv('Puntos_Reunion_4_Completos_AB_3_1.csv', index=False)

print("¡Archivo 'Puntos_Reunion_4_Completos_AB.csv' guardado con éxito en tu carpeta!")