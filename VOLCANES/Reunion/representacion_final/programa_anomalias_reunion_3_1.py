# -*- coding: utf-8 -*-
"""
Created on Tue Apr 28 13:19:08 2026
...
# =============================================================================
# BLOQUE 1: CARGA DE DATOS DIGITALIZADOS (REUNIÓN, densidad = 3.1)
# =============================================================================
print("1. Cargando datos digitalizados...")

ruta_csv = r"C:\Users\Usuario\Gravity-data-\VOLCANES\Reunion\Puntos_Reunion_4_Completos_AB_3_1.csv"
...
rho_roca = 3100  # Densidad estándar
rho_agua = 1030
...
fig_1 = pygmt.Figure()
fig_1.basemap(region=region, projection="M15c", frame=["af", 'WSen+t"Reunion {rho} = 3.1 g/cm3: Bouguer Simple (Digitalizado)"'])
fig_1.coast(shorelines="0.2p,black", water="lightblue", land="lightgray", resolution="f")
...
fig_2 = pygmt.Figure()
fig_2.basemap(region=region, projection="M15c", frame=["af", 'WSen+t"Reunion {rho} = 3.1 g/cm3: Bouguer Completa (Digitalizado)"'])
fig_2.coast(shorelines="0.2p,black", water="lightblue", land="lightgray", resolution="f")
...
df_final.to_csv("Reunion_3_1_Resultados_Completos.csv", index=False)
