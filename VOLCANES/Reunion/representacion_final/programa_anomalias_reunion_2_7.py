# -*- coding: utf-8 -*-
"""
Created on Tue Apr 28 12:43:34 2026
...
# =============================================================================
# BLOQUE 1: CARGA DE DATOS DIGITALIZADOS (REUNIÓN, densidad = 2.7)
# =============================================================================
print("1. Cargando datos digitalizados...")

ruta_csv = r"C:\Users\Usuario\Gravity-data-\VOLCANES\Reunion\Puntos_Reunion_1_2.7_Completos.csv"
...
rho_roca = 2700  # Densidad estándar
rho_agua = 1030
...
fig_1 = pygmt.Figure()
fig_1.basemap(region=region, projection="M15c", frame=["af", 'WSen+t"Reunion {rho} = 2.7 g/cm3: Bouguer Simple (Digitalizado)"'])
...
fig_2 = pygmt.Figure()
fig_2.basemap(region=region, projection="M15c", frame=["af", 'WSen+t"Reunion {rho} = 2.7 g/cm3: Bouguer Completa (Digitalizado)"'])
...
df_final.to_csv("Reunion_2_7_Resultados_Completos.csv", index=False)
