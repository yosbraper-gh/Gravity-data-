# -*- coding: utf-8 -*-
"""
Created on Fri Apr 24 11:47:36 2026
...
df = pd.read_csv(r"C:\Users\Usuario\Desktop\IGN\Lineas de Canarias\El Hierro\Datos_IGN_El_Hierro.csv", dtype=str)
...
# =============================================================================
margin = 0.05
region = [-18.25, -17.85, 27.60, 27.90]
