# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 12:22:35 2026
...
gdf_lineas = gpd.read_file('datos_lzt_fa_2.gpkg')
...
df_final.to_csv('Puntos_Lanzarote_Completos_Fa.csv', index=False)

print("¡Archivo 'Puntos_Lanzarote_Completos_Fa.csv' guardado con éxito en tu carpeta!")