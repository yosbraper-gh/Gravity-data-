# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 11:48:44 2026
...
gdf_lineas = gpd.read_file('datos_ftv_fa.gpkg')
...
df_final.to_csv('Puntos_Fuerteventura_Completos_Fa.csv', index=False)

print("¡Archivo 'Puntos_Futerteventura_Completos_Fa.csv' guardado con éxito en tu carpeta!")