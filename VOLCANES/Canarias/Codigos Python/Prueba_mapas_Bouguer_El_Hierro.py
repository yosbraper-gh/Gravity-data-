# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 10:28:14 2026
...
# Extensión del mapa — ajusta a El Hierro
ax.set_extent([-18.22, -17.83, 27.58, 27.90], crs=ccrs.PlateCarree())
...
ax.set_title("Complete Bouguer Anomaly Map\n ElHierro (mGal) — Harmonica Equivalent Sources",
...
bbox = box(-18.22, 27.58, -17.83, 27.90)
