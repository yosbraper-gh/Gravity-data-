# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 11:37:15 2026
...
# 1. CARGAR DATOS
# ============================================================
df = pd.read_csv("Datos_La_Gomera_Finales.csv")
...
ax.set_extent([-17.40, -17.05, 27.95, 28.25], crs=ccrs.PlateCarree())
...
bbox = box(-17.40, -17.05, 27.95, 28.25)
