# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 13:48:14 2026
...
# 1. CARGAR DATOS
# ============================================================
df = pd.read_csv("Datos_Fuerteventura_finales.csv")
...
# Extensión del mapa — ajustado a La Gomera
ax.set_extent([-14.55, -13.80, 28.00, 28.80], crs=ccrs.PlateCarree())
...
bbox = box(-14.55, -13.80, 28.00, 28.80)
